...
class IController extends IControllerBase
{
	...
	public function run()
	{
		...
		IInterceptor::run("onCreateAction",$this);
		$actionObj->run();
	...
	{
		return $this->getViewPath().$this->app->defaultSkinDir.DIRECTORY_SEPARATOR.$this->getSkinDir().DIRECTORY_SEPARATOR;
	}
	...
	{
		return $this->app->getViewPath().$this->getThemeDir().DIRECTORY_SEPARATOR;
	}
