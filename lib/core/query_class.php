...
{
	private $dbo      = null;
	private $sql      = array('table'=>'','fields'=>'*','where'=>'','join'=>'','group'=>'','having'=>'','order'=>'','limit'=>'limit 5000','distinct'=>'');
	private $tablePre = '';
	private $cache    = null;
	public  $paging   = null;
	public  $debug    = 0; //0:关闭;1:开启;
