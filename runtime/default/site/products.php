...
<link rel="stylesheet" type="text/css" href="<?php echo $this->getWebViewPath()."javascript/jquery.jqzoom/css/jquery.jqzoom.css";?>" />
<script type="text/javascript" src="<?php echo $this->getWebViewPath()."javascript/jquery.jqzoom/js/jquery.jqzoom-core-pack.js";?>"></script>

<link rel="stylesheet" type="text/css" href="<?php echo $this->getWebViewPath()."javascript/jquery.bxSlider/jquery.bxslider.css";?>" />
<script type="text/javascript" src="<?php echo $this->getWebViewPath()."javascript/jquery.bxSlider/jquery.bxSlider.min.js";?>"></script>
	...
	<div class="summary">
		...
		<ul>
			...
			<?php if($promo == 'time'){?>
				...
				<?php }else{?>
				<!--抢购过期-->
				<li><span class="f30"><img src="<?php echo $this->getWebSkinPath()."images/front/grab_expir.png";?>" style="float:right;" name="timeover" /></span></li>
			...
			<?php if($promo == 'groupon'){?>
				...
				<?php }else{?>
				<!--团购过期-->
				<li><span class="f30"><img src="<?php echo $this->getWebSkinPath()."images/front/group_expir.png";?>" style="float:right;" name="timeover" /></span></li>
				<li>销售价：<b class="price red2"><span class="f30"><?php if($minSellPrice != $maxSellPrice){?>￥<?php echo isset($minSellPrice)?$minSellPrice:"";?> - ￥<?php echo isset($maxSellPrice)?$maxSellPrice:"";?><?php }else{?>￥<?php echo isset($sell_price)?$sell_price:"";?><?php }?></span></b></li>
				<?php }?>
			<?php }?>
			...
			<li>立即咨询：<?php Sonline::qqShow($seller['server_num'])?></li>
			<?php }?>
			<!--商家信息 结束-->
		</ul>
				...
				<div class="shopping" id="product_myCart" style='display:none'>
					<dl class="cart_stats">
						<dt class="gray f14 bold">
							...
							<img src="<?php echo $this->getWebSkinPath()."images/front/right_s.gif";?>" width="24" height="24" alt="" />成功加入购物车
						</dt>
	...
	<div class="preview">
		<div class="pic_show" style="width:435px;height:435px;position:relative;z-index:5;padding-bottom:5px;">
			<a class="jqzoom" href="javascript:void(0)" rel='goodsPhoto' id="bigPicBox" alt="原图">
				<img src="<?php echo $this->getWebSkinPath()."images/front/nopic_435_435.gif";?>" style="border:none;" id="smallPicBox" alt="缩略图" />
			</a>
		</div>
		...
		<div name="showBox">
			...
			<div class="hidden comment_list box">
				<div class="title3">
					...
					<img src="<?php echo $this->getWebSkinPath()."images/front/comm.gif";?>" width="16px" height="16px" />商品评论<span class="f12 normal">（已有<b class="red2"><?php echo isset($comments)?$comments:"";?></b>条）</span>
				</div>
			...
			<!-- 售后服务 start -->
			<div class="hidden box">
				<div class="title3"><img src="<?php echo $this->getWebSkinPath()."images/front/tel.gif";?>" width="20px" height="19px" />售后服务</div>
			...
			<!-- 支付方式 start -->
			<div class="hidden box">
				<div class="title3"><img src="<?php echo $this->getWebSkinPath()."images/front/card.gif";?>" width="23px" height="18px" />支付方式</div>
				<div class="cont_pay">
...
//图片初始化
var goodsSmallPic = "<?php echo $this->getWebSkinPath()."images/front/nopic_435_435.gif";?>";
var goodsBigPic   = "<?php echo $this->getWebSkinPath()."images/front/nopic_435_435.gif";?>";
