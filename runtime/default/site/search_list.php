		...
		<ul class="display_list clearfix m_10">
			...
			<li class="clearfix <?php echo search_goods::getListShow(IFilter::act(IReq::get('show_type')));?>">
				...
				<div class="handle">
					...
					<label class="btn_gray_m"><img src="<?php echo $this->getWebSkinPath()."images/front/ucenter/favorites.gif";?>" width="15" height="14" /><input type="button" value="收藏" onclick="favorite_add_ajax('<?php echo IUrl::creatUrl("/simple/favorite_add");?>','<?php echo isset($item['id'])?$item['id']:"";?>',this);"></label>
				</div>
