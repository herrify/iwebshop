...
<div class="ucenter container">
    ...
    <div class="box m_10">
        <table class="list_table m_10" width="100%" cellpadding="0" cellspacing="0">
            ...
            <?php $queryRefundmentDocList = Api::run('getRefundmentDocList',$user_id)?>
	    	<?php foreach($queryRefundmentDocList->find() as $key => $item){?>
                <tr>
                	...
                	<td>
                		<?php if($item['pay_status']==0){?><a class="blue" href='javascript:delModel({link:"<?php echo IUrl::creatUrl("/ucenter/refunds_del/id/".$item['id']."");?>"})'>取消</a>|<?php }?>
                		<a class="blue" href="<?php echo IUrl::creatUrl("/ucenter/refunds_detail/id/".$item['id']."");?>">查看</a>
                	</td>
                </tr>
            <?php }?>
            </tbody>
			<tfoot><tr><td colspan="4" class="t_l"><?php echo $queryRefundmentDocList->getPageBar();?></td></tr></tfoot>
        </table>
	</div>
</div>
	</div>
