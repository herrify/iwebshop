...
<div class="main f_r">
	...
	<div class="box">
		<div class="title">
			...
			<?php foreach(Api::run('getUcenterFavoriteByCatid',array('#user_id#',$user_id)) as $key => $item){?>
				...
				<tr>
					...
					<td>
						<dl>
							...
							<dt><a href="<?php echo IUrl::creatUrl("/site/products/id/".$tmp."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$tmpIMG."/w/88/h/88");?>" width="88px" height="88px" alt="<?php echo isset($item['data']['name'])?$item['data']['name']:"";?>" /></a></dt>
