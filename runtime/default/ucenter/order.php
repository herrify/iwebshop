...
<div class="ucenter container">
    ...
    <div class="box m_10">
        <table class="list_table" width="100%" cellpadding="0" cellspacing="0">
            ...
            <?php $queryOrderList = Api::run('getOrderList',$user_id)?>
			<?php foreach($queryOrderList->find() as $key => $item){?>
            <tr>
                <td>
            ...
            <tfoot><tr><td colspan="6" class="t_l"><?php echo $queryOrderList->getPageBar();?></td></tr></tfoot>
        </table>
    </div>
</div>
	</div>
