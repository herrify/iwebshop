...
<div class="headbar">
	...
	<div class="searchbar">
		<form action="<?php echo IUrl::creatUrl("/");?>" method="get" name="searchListForm">
			...
			<button class="btn" type="button" onclick="selectGoodsCategory('<?php echo IUrl::creatUrl("/block/goods_category/type/radio");?>','search[category_id]')"><span class="add">设置分类</span></button>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<?php echo IUrl::creatUrl("/site/home/id/".$item['seller_id']."");?>" target="_blank" title="<?php echo isset($item['true_name'])?$item['true_name']:"";?>"><img title="<?php echo isset($item['true_name'])?$item['true_name']:"";?>" src="<?php echo $this->getWebSkinPath()."images/admin/seller_ico.png";?>" /></a>
						<?php }?>
...
function goodsShare()
{
	if($('input:checkbox[name="id[]"]:checked').length > 0)
	{
		...
		$.getJSON("<?php echo IUrl::creatUrl("/goods/goods_share");?>",{"id":idString.join(',')},function(json)
		{
