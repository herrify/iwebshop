	...
	<form action='<?php echo IUrl::creatUrl("/goods/spec_del");?>' method='post' name='specForm'>
		<table class="list_table">
			...
			<tbody>
				...
				<?php $query = new IQuery("spec");$query->where = "is_del = 0 and seller_id = 0";$query->order = "id desc";$query->page = "$page";$query->pagesize = "20";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>
