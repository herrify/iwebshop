			...
			<table class="form_table">
				...
				<tr>
					...
					<td>
						...
						<button class="btn" type="button" onclick="selectGoodsCategory('<?php echo IUrl::creatUrl("/block/goods_category/type/radio");?>','goods_category_id')"><span class="add">设置分类</span></button>
					</td>
				</tr>
				<tr>
...
//商品分类回填
<?php if(isset($this->catRow['goods_category_id'])){?>
<?php $categoryId = $this->catRow['goods_category_id']?>
