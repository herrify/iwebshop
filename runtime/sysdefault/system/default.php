...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<?php $site_config = new Config('site_config');$store_num_warning = $site_config->store_num_warning ? $site_config->store_num_warning : 20?>
					...
					<td>
						<table class="list_table2" width="100%">
							...
							<tbody>
								...
								<tr><th>库存预警</th><td><?php $query = new IQuery("goods");$query->fields = "count(id) as countNums";$query->where = "store_nums < $store_num_warning";$items = $query->find(); foreach($items as $key => $item){?><a href="javascript:formSubmit('storeNumWarning');"><b class="f14 red3"><?php echo isset($item['countNums'])?$item['countNums']:"";?></b> 个</a><?php }?></td></tr>
							</tbody>
						</table>
					</td>
				</tr>
