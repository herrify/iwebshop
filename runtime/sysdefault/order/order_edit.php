			...
			<table class="form_table">
				...
				<tbody>
					<tr>
						<th>所属用户名:</th>
						<td>
							<input type='text' name='username' value='<?php echo $this->username;?>' class='normal' />
...
function searchGoodsCallback(goodsList)
{
	...
	goodsList.each(function()
	{
		...
		var insertObject = {"id":temp.goods_id,"name":temp.name,"real_price":temp.sell_price,"product_id":temp.product_id,"spec_array":$.parseJSON(temp.spec_array),"goods_no":temp.goods_no};
